    ...
    return (
            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">September 02, 2022</bdt>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
              <span data-custom-class="body_text">
                This privacy notice for <bdt className="question">__________</bdt>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">
                    <a
                      href="https://notexchange.shop/"
                      target="_blank"
                      data-custom-class="link"
                    >
                      https://notexchange.shop/
                    </a>
                  </bdt>
                  <span style={{ fontSize: 15 }}>
                    <span style={{ color: "rgb(89, 89, 89)" }}>
        ...
        <div>
            ...
            <span style={{ fontSize: 15 }}>
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span data-custom-class="body_text">
                  ...
                  contact us at <bdt className="question">saytoukoni@gmail.com</bdt>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            <a
              data-custom-class="link"
              href="https://app.termly.io/notify/7352f46f-54f8-4a83-bd78-52ddff58fef2"
                                                    ...
                                                    <li style={{ lineHeight: "1.5" }}>
                                                      <span data-custom-class="body_text">
                                                        ...
                                                        >
                                                          ...
                                                          individual has been, is, or
                                                          may be victim of financial
                                                          abuse
                                                          <bdt className="statement-end-if-in-editor" />
                                                        </span>
                                                      </span>
