...
function Login({ history }) {
    ...
    return (
        <>
            <SimpleSider />
            <div className="container auth-form" style={{textAlign: "center", backgroundColor: '#4068FC'}}>
                <h1 style={{color:'#FFFFFF' }} className="auth-heading">SIGN IN</h1>
                <Form className="col-lg-6" onSubmit={handleSubmitLogin}>
                    ...
                    {loading ?
                        <Button style={{color:'#FFFFFF' }} className="col-lg-12 btnAuth" variant="dark" disabled >
                            Please wait... <Spinner animation="border" />
                        </Button>
                        :
                        <Button variant="dark" className="col-lg-12 btnAuth" type="submit">Sign In</Button>
                    }
                    <p style={{color:'#FFFFFF' }} className="bottom-msg-paragraph">Don't have an account? <Link to="/auth/register">Sign Up</Link>!</p>
                </Form>
            </div>
        </>
    )
