...
function Messages({ match }) {
    ...
    return (
        <Container>
            <Row>
                <aside className="col-lg-4 col-md-4" style={{textAlign: "center", backgroundColor: '#4068FC'}}>
                    <h3 style={{color:'#FFFFFF' }}>Messages</h3>
                    {conversations.length >= 1 ?
                        ...
                        :
                        <h5 style={{color:'#FFFFFF' }}>No messages yet</h5>
                    }
                </aside>
