...
import { BsFillPersonFill, BsFillEnvelopeFill, BsFillPlusCircleFill, BsFillQuestionCircleFill } from 'react-icons/bs';
import { Route } from 'react-router-dom';
import { IoLogOut } from 'react-icons/io5'
import logo from './ne.png';
import './Header.css'
function Header() {
        ...
        <Navbar collapseOnSelect bg="light" variant="light">
            <div className="container">
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    {userData ?
                        (<Nav>
                            <NavLink className="nav-item" id="addButton" to="/pay">
                                <OverlayTrigger key="bottom" placement="bottom"
                                    overlay={
                                        <Tooltip id={`tooltip-bottom`}>
                                            <strong>Add</strong> an item.
                                        </Tooltip>
                                    }
                                > 
                            ...
                            <NavLink className="nav-item" id="addButton" to="/about">
                                <OverlayTrigger key="bottom" placement="bottom"
                                    overlay={
                                        <Tooltip id={`tooltip-bottom`}>
            ...
            path="/about"
            component={() => {
              window.location.replace('https://magical-longma-34be9d.netlify.app');
              return null;
            }}
          />
        </Navbar>
